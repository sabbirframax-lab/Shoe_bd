...
const Success: React.FC = () => {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-50 px-4">
      ...
      <h1 className="text-3xl md:text-4xl font-extrabold text-gray-900 mb-4 text-center">Order Confirmed!</h1>
      <p className="text-lg text-gray-600 mb-8 max-w-md text-center">
        Thank you for your purchase. Your order has been placed successfully and will be delivered soon via Cash on Delivery.
      </p>
      
      <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 mb-8 w-full max-w-md text-center">
        <p className="text-sm text-gray-500 mb-2">Order Reference Number</p>
